...
from .views import user_login, register, home, create_training_plan, delete_training_plan, update_training_plan,update_trainer_notes, mark_training_plan_done
